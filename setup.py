"""A setuptools based setup module for ODPSlides

See:
http://odpslides.readthedocs.org/en/latest/
https://github.com/sonofeft/ODPSlides

If installing from source, then
the best way to install ODPSlides is to use pip after navigating to the source directory::
...
target_file = path.join( here, 'odpslides','_version.py')
...
setup(
    ...
    description = 'Creates OpenDocument Presentations for Microsoft PowerPoint, LibreOffice and OpenOffice',
    long_description = long_description,

    # The project's main homepage.
    url='http://odpslides.readthedocs.org/en/latest/',
    download_url='https://github.com/sonofeft/ODPSlides',
    ...
    package_data = {'odpslides':['templates/*.*', 'templates/.*', 'examples/*.*']},
