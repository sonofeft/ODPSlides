...
def draw_8_page_Master1_PPL1():
    ...
    elem = build_element( """<draw:page draw:name="Slide1" draw:style-name="a1027" draw:master-page-name="Master1-Layout1-title-Title-Slide" presentation:presentation-page-layout-name="Master1-PPL1" draw:id="Slide-256">
...
def draw_8_page_Master1_PPL12():
    ...
    elem = build_element( """<draw:page draw:name="Slide2" draw:style-name="a1038" draw:master-page-name="Master1-Layout12-tx-Title-and-Text" presentation:presentation-page-layout-name="Master1-PPL12" draw:id="Slide-257">
...
<text:list text:style-name="a1047">
<text:list-item>
<text:p text:style-name="a1046" text:class-names="" text:cond-style-name="">
...
def draw_8_page_Master1_PPL13():
    ...
    elem = build_element( """<draw:page draw:name="Slide3" draw:style-name="a1050" draw:master-page-name="Master1-Layout13-twoColTx-Title-and-2-Column-Text" presentation:presentation-page-layout-name="Master1-PPL13" draw:id="Slide-258">
...
def draw_8_page_Master1_PPL2():
    ...
    elem = build_element( """<draw:page draw:name="Slide4" draw:style-name="a1069" draw:master-page-name="Master1-Layout2-obj-Title-and-Content" presentation:presentation-page-layout-name="Master1-PPL2" draw:id="Slide-259">
...
<draw:frame draw:id="id154" presentation:style-name="a1073" draw:name="Content Placeholder 3" svg:x="2.91667in" svg:y="2.66233in" svg:width="4.16667in" svg:height="3.125in" style:rel-width="scale" style:rel-height="scale" presentation:class="graphic" presentation:placeholder="false">
...
def draw_8_page_Master1_PPL14():
    ...
    elem = build_element( """<draw:page draw:name="Slide5" draw:style-name="a1075" draw:master-page-name="Master1-Layout14-txOverObj-Title-and-Text-over-Content" presentation:presentation-page-layout-name="Master1-PPL14" draw:id="Slide-260">
...
<draw:frame draw:id="id157" presentation:style-name="a1086" draw:name="Content Placeholder 4" svg:x="3.40509in" svg:y="4.30729in" svg:width="3.18981in" svg:height="2.39236in" style:rel-width="scale" style:rel-height="scale" presentation:class="graphic" presentation:placeholder="false">
...
def draw_8_page_Master1_PPL15():
    ...
    elem = build_element( """<draw:page draw:name="Slide6" draw:style-name="a1088" draw:master-page-name="Master1-Layout15-txAndObj-Title,-Text,-and-Content" presentation:presentation-page-layout-name="Master1-PPL15" draw:id="Slide-261">
...
<draw:frame draw:id="id160" presentation:style-name="a1099" draw:name="Content Placeholder 4" svg:x="5.20833in" svg:y="2.66233in" svg:width="4.16667in" svg:height="3.125in" style:rel-width="scale" style:rel-height="scale" presentation:class="graphic" presentation:placeholder="false">
...
def draw_8_page_Master1_PPL4():
    ...
    elem = build_element( """<draw:page draw:name="Slide7" draw:style-name="a1101" draw:master-page-name="Master1-Layout4-twoObj-Two-Content" presentation:presentation-page-layout-name="Master1-PPL4" draw:id="Slide-262">
...
<draw:frame draw:id="id162" presentation:style-name="a1105" draw:name="Content Placeholder 4" svg:x="0.625in" svg:y="2.66233in" svg:width="4.16667in" svg:height="3.125in" style:rel-width="scale" style:rel-height="scale" presentation:class="graphic" presentation:placeholder="false">
<draw:image xlink:href="media/image4.png" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad" />
<svg:title />
<svg:desc />
</draw:frame>
<draw:frame draw:id="id163" presentation:style-name="a1106" draw:name="Content Placeholder 5" svg:x="5.20833in" svg:y="2.66233in" svg:width="4.16667in" svg:height="3.125in" style:rel-width="scale" style:rel-height="scale" presentation:class="graphic" presentation:placeholder="false">
...
def draw_8_page_Master1_PPL16():
    ...
    elem = build_element( """<draw:page draw:name="Slide8" draw:style-name="a1108" draw:master-page-name="Master1-Layout16-objAndTx-Title,-Content-and-Text" presentation:presentation-page-layout-name="Master1-PPL16" draw:id="Slide-263">
...
<draw:frame draw:id="id165" presentation:style-name="a1112" draw:name="Content Placeholder 4" svg:x="0.625in" svg:y="2.66233in" svg:width="4.16667in" svg:height="3.125in" style:rel-width="scale" style:rel-height="scale" presentation:class="graphic" presentation:placeholder="false">
<draw:image xlink:href="media/image6.png" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad" />
<svg:title />
<svg:desc />
</draw:frame>
<draw:frame draw:id="id166" presentation:style-name="a1119" draw:name="Text Placeholder 3" svg:x="5.08333in" svg:y="1.75in" svg:width="4.41667in" svg:height="4.94965in" presentation:class="outline" presentation:placeholder="false">
<draw:text-box>
<text:list text:style-name="a1115">
<text:list-item>
<text:p text:style-name="a1114" text:class-names="" text:cond-style-name="">
<text:span text:style-name="a1113" text:class-names="">
Text(3)</text:span>
</text:p>
</text:list-item>
</text:list>
...
def draw_8_page_Master1_PPL17():
    ...
    elem = build_element( """<draw:page draw:name="Slide9" draw:style-name="a1121" draw:master-page-name="Master1-Layout17-txAndTwoObj-Title,-Text,-and-2-Content" presentation:presentation-page-layout-name="Master1-PPL17" draw:id="Slide-264">
...
<draw:frame draw:id="id169" presentation:style-name="a1132" draw:name="Content Placeholder 5" svg:x="5.69792in" svg:y="1.75in" svg:width="3.1875in" svg:height="2.39063in" style:rel-width="scale" style:rel-height="scale" presentation:class="graphic" presentation:placeholder="false">
<draw:image xlink:href="media/image7.png" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad" />
<svg:title />
<svg:desc />
</draw:frame>
<draw:frame draw:id="id170" presentation:style-name="a1133" draw:name="Content Placeholder 6" svg:x="5.69676in" svg:y="4.30729in" svg:width="3.18981in" svg:height="2.39236in" style:rel-width="scale" style:rel-height="scale" presentation:class="graphic" presentation:placeholder="false">
...
def draw_8_page_Master1_PPL18():
    ...
    elem = build_element( """<draw:page draw:name="Slide10" draw:style-name="a1135" draw:master-page-name="Master1-Layout18-objAndTwoObj-Title,-Content,-and-2-Content" presentation:presentation-page-layout-name="Master1-PPL18" draw:id="Slide-265">
...
<draw:frame draw:id="id172" presentation:style-name="a1139" draw:name="Content Placeholder 5" svg:x="0.625in" svg:y="2.66233in" svg:width="4.16667in" svg:height="3.125in" style:rel-width="scale" style:rel-height="scale" presentation:class="graphic" presentation:placeholder="false">
<draw:image xlink:href="media/image9.png" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad" />
<svg:title />
<svg:desc />
</draw:frame>
<draw:frame draw:id="id173" presentation:style-name="a1140" draw:name="Content Placeholder 6" svg:x="5.69792in" svg:y="1.75in" svg:width="3.1875in" svg:height="2.39063in" style:rel-width="scale" style:rel-height="scale" presentation:class="graphic" presentation:placeholder="false">
<draw:image xlink:href="media/image10.png" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad" />
<svg:title />
<svg:desc />
</draw:frame>
<draw:frame draw:id="id174" presentation:style-name="a1141" draw:name="Content Placeholder 7" svg:x="5.69676in" svg:y="4.30729in" svg:width="3.18981in" svg:height="2.39236in" style:rel-width="scale" style:rel-height="scale" presentation:class="graphic" presentation:placeholder="false">
...
def draw_8_page_Master1_PPL19():
    ...
    elem = build_element( """<draw:page draw:name="Slide11" draw:style-name="a1143" draw:master-page-name="Master1-Layout19-objOverTx-Title-and-Content-over-Text" presentation:presentation-page-layout-name="Master1-PPL19" draw:id="Slide-266">
...
<draw:text-box>
<text:p text:style-name="a1145" text:class-names="" text:cond-style-name="">
<text:span text:style-name="a1144" text:class-names="">
...
<draw:frame draw:id="id176" presentation:style-name="a1147" draw:name="Content Placeholder 4" svg:x="3.40625in" svg:y="1.75in" svg:width="3.1875in" svg:height="2.39063in" style:rel-width="scale" style:rel-height="scale" presentation:class="graphic" presentation:placeholder="false">
<draw:image xlink:href="media/image12.png" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad" />
<svg:title />
<svg:desc />
</draw:frame>
<draw:frame draw:id="id177" presentation:style-name="a1154" draw:name="Text Placeholder 3" svg:x="0.5in" svg:y="4.30729in" svg:width="9in" svg:height="2.39236in" presentation:class="outline" presentation:placeholder="false">
<draw:text-box>
...
<text:list text:style-name="a1153">
<text:list-item>
<text:p text:style-name="a1152" text:class-names="" text:cond-style-name="">
<text:span text:style-name="a1151" text:class-names="">
...
def draw_8_page_Master1_PPL20():
    ...
    elem = build_element( """<draw:page draw:name="Slide12" draw:style-name="a1156" draw:master-page-name="Master1-Layout20-fourObj-Title-and-4-Content" presentation:presentation-page-layout-name="Master1-PPL20" draw:id="Slide-267">
...
<draw:frame draw:id="id179" presentation:style-name="a1160" draw:name="Content Placeholder 6" svg:x="1.11458in" svg:y="1.75in" svg:width="3.1875in" svg:height="2.39063in" style:rel-width="scale" style:rel-height="scale" presentation:class="graphic" presentation:placeholder="false">
<draw:image xlink:href="media/image13.png" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad" />
<svg:title />
<svg:desc />
</draw:frame>
<draw:frame draw:id="id180" presentation:style-name="a1161" draw:name="Content Placeholder 7" svg:x="5.69792in" svg:y="1.75in" svg:width="3.1875in" svg:height="2.39063in" style:rel-width="scale" style:rel-height="scale" presentation:class="graphic" presentation:placeholder="false">
<draw:image xlink:href="media/image14.png" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad" />
<svg:title />
<svg:desc />
</draw:frame>
<draw:frame draw:id="id181" presentation:style-name="a1162" draw:name="Content Placeholder 8" svg:x="1.11343in" svg:y="4.30729in" svg:width="3.18981in" svg:height="2.39236in" style:rel-width="scale" style:rel-height="scale" presentation:class="graphic" presentation:placeholder="false">
<draw:image xlink:href="media/image15.png" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad" />
<svg:title />
<svg:desc />
</draw:frame>
<draw:frame draw:id="id182" presentation:style-name="a1163" draw:name="Content Placeholder 9" svg:x="5.69676in" svg:y="4.30729in" svg:width="3.18981in" svg:height="2.39236in" style:rel-width="scale" style:rel-height="scale" presentation:class="graphic" presentation:placeholder="false">
...
def draw_8_page_Master1_PPL21():
    ...
    elem = build_element( """<draw:page draw:name="Slide13" draw:style-name="a1165" draw:master-page-name="Master1-Layout21-twoObjAndObj-Title,-2-Content-and-Content" presentation:presentation-page-layout-name="Master1-PPL21" draw:id="Slide-268">
...
<draw:text-box>
<text:p text:style-name="a1167" text:class-names="" text:cond-style-name="">
<text:span text:style-name="a1166" text:class-names="">
...
<draw:frame draw:id="id184" presentation:style-name="a1169" draw:name="Content Placeholder 5" svg:x="1.11458in" svg:y="1.75in" svg:width="3.1875in" svg:height="2.39063in" style:rel-width="scale" style:rel-height="scale" presentation:class="graphic" presentation:placeholder="false">
<draw:image xlink:href="media/image17.png" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad" />
<svg:title />
<svg:desc />
</draw:frame>
<draw:frame draw:id="id185" presentation:style-name="a1170" draw:name="Content Placeholder 6" svg:x="1.11343in" svg:y="4.30729in" svg:width="3.18981in" svg:height="2.39236in" style:rel-width="scale" style:rel-height="scale" presentation:class="graphic" presentation:placeholder="false">
...
def draw_8_page_Master1_PPL22():
    ...
    elem = build_element( """<draw:page draw:name="Slide14" draw:style-name="a1173" draw:master-page-name="Master1-Layout22-twoObjAndTx-Title,-2-Content-and-Text" presentation:presentation-page-layout-name="Master1-PPL22" draw:id="Slide-269">
...
<draw:text-box>
<text:p text:style-name="a1175" text:class-names="" text:cond-style-name="">
<text:span text:style-name="a1174" text:class-names="">
...
<text:list-item>
<text:p text:style-name="a1180" text:class-names="" text:cond-style-name="">
<text:span text:style-name="a1179" text:class-names="">
Text(4)</text:span>
</text:p>
</text:list-item>
</text:list>
...
<text:list text:style-name="a1184">
<text:list-item>
<text:p text:style-name="a1183" text:class-names="" text:cond-style-name="">
...
def draw_8_page_Master1_PPL23():
    ...
    elem = build_element( """<draw:page draw:name="Slide15" draw:style-name="a1187" draw:master-page-name="Master1-Layout23-twoObjOverTx-Title-and-2-Content-over-Text" presentation:presentation-page-layout-name="Master1-PPL23" draw:id="Slide-270">
...
<draw:text-box>
<text:p text:style-name="a1189" text:class-names="" text:cond-style-name="">
<text:span text:style-name="a1188" text:class-names="">
...
<text:list-item>
<text:p text:style-name="a1194" text:class-names="" text:cond-style-name="">
<text:span text:style-name="a1193" text:class-names="">
Text(4)</text:span>
</text:p>
</text:list-item>
</text:list>
...
<text:list text:style-name="a1198">
<text:list-item>
<text:p text:style-name="a1197" text:class-names="" text:cond-style-name="">
...
def draw_8_page_Master1_PPL24():
    ...
    elem = build_element( """<draw:page draw:name="Slide16" draw:style-name="a1201" draw:master-page-name="Master1-Layout24-tbl-Title-and-Table" presentation:presentation-page-layout-name="Master1-PPL24" draw:id="Slide-271">
...
<draw:frame draw:id="id196" presentation:style-name="a1205" draw:name="Table Placeholder 2" svg:x="0.5in" svg:y="1.75in" svg:width="9in" svg:height="4.94965in" presentation:class="table" presentation:placeholder="true">
<draw:text-box />
<svg:title />
<svg:desc />
</draw:frame>
