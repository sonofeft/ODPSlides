...
# -*- coding: utf-8 -*-
#
# ODPSlides documentation build configuration file, created by
...
target_file = os.path.join( up_one, 'odpslides','_version.py')
...
htmlhelp_basename = 'ODPSlidesdoc'
...
latex_documents = [
  (master_doc, 'ODPSlides.tex', u'ODPSlides Documentation',
...
man_pages = [
    (master_doc, 'projectabcxyz', u'ODPSlides Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'ODPSlides', u'ODPSlides Documentation',
   author, 'ODPSlides', 'One line description of project.',
   'Miscellaneous'),
]
